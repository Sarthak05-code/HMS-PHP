  ...
  <main class="main">
    ...
    <div class="card">
      ...
      <div class="table-wrap">
        <table>
          <thead>
            <tr><th>Name</th><th>Section</th><th>Class</th><th>Gender</th><th>Status</th><th>Enrolled</th></tr>
          </thead>
          <tbody>
      ...
      <?php else: ?>
        <div class="empty-state"><div class="empty-icon">🎓</div><p>No students added yet.</p></div>
      <?php endif; ?>
    </div>
  </main>
</div>
